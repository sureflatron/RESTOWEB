    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Reporte de Ventas Detalladas Por Usuarios</h5>
                <ol class="breadcrumbs">
                    <li><a href="/index">Dashboard</a></li>
                    <li class="active">Reporte de Ventas Detalladas Por Usuarios</li>
                </ol>
            </div>
        </div>
    </div>
...
@endsection
@section('Contenido')
<h4><strong>Reporte de Ventas Detalladas por Usuario</strong></h4>
<div class="row">
    <div class="col s12">
...
<div class="row">
    <div class="col s12">
        {!!link_to('#', $title='Generar', $attributes = ['id'=>'detalleventasporusuario', 'class'=>'btn btn-primary'], $secure = null)!!}
    </div>
</div>
@stop
@section('scripts')
