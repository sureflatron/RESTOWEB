    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Reporte de Ventas Por Usuarios</h5>
                <ol class="breadcrumbs">
                    <li><a href="/index">Dashboard</a></li>
                    <li class="active">Reporte de Ventas Por Usuarios</li>
                </ol>
            </div>
        </div>
    </div>
...
@endsection
@section('Contenido')
<h4><strong>Reporte de Venta por usuarios</strong></h4>
<div class="row">
    <div class="col s12">
