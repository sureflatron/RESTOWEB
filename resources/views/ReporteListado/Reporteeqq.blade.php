    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Reporte del Analisis ABC</h5>
                <ol class="breadcrumbs">
                    <li><a href="/index">Dashboard</a></li>
                    <li class="active">Reporte del Analisis ABC </li>
                </ol>
            </div>
        </div>
    </div>
...
@endsection
@section('Contenido')
<h4><strong>Reporte del Analisis ABC para Inventarios</strong></h4>
<div class="row">
...
<div class="row">
    <div class="col s12 m5 l3">
        {!!link_to('#', $title='Generar', $attributes = ['id'=>'analisiseqq', 'class'=>'btn btn-primary'], $secure = null)!!}
    </div>
</div>
<div class="row">
    <div class="col s12">
