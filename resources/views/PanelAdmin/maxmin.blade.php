        ...
        <div id="chart-dashboard">
            ...
            <div class="row">
                ...
                <div class="col s12 m12 l12">  
                    <strong>MAXIMOS Y MINIMOS POR ALMACEN :</strong>
                      <div class="row">
                      <div class="col s4 m4 l4">
                       ...
                       <div class="col s12 m12 l12">
                          ...
                          <div class="col s4 m4 l4"> 
                              <strong>  AÑO DE STOCK SEGURIDAD :</strong> 
                          <select id="anio" name="year">
                              <script>
                              var myDate = new Date();
                              var year = myDate.getFullYear();
                              var unomenos=year-1
                              for(var i = unomenos; i < year+1; i++)
                              {
                                  if(i==unomenos){
                    ...
                    <a class="btn"  OnClick='ejecutarmaxminanual();'>Exec_Max_Min_Anual</a>
                        </div>  
                    </div>
                    ...
                    <div class="card">
                        <div class="card-move-up waves-effect waves-block waves-light">
                            <div class="move-up cyan darken-1">
                                <div>
                                    <span class="chart-title white-text"><strong>Stock-Maximos-Minimos Inv.</strong></span>
                                </div>
...
<!--chart dashboard end-->
@section('scripts')
{!!Html::script('js/maxmin.min.js')!!}
{!!Html::script('js/maxmin.js')!!}
