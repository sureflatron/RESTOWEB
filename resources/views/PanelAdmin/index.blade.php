                ...
                <div class="col s12 m12 l12">
                   ...
                   <!--div id="container" style="min-width: 310px; height: 400px; margin: 0 auto"></div-->  
                    <div class="card">
                        <div class="card-move-up waves-effect waves-block waves-light">
                            <div class="move-up cyan darken-1">
                                <div>
                                    <span class="chart-title white-text"><strong>VENTAS SEMANALES</strong></span>
                                </div>
                    ...
                    <div class="card-content">
                            <a class="btn-floating btn-move-up waves-effect waves-light darken-2 right" style="background-color: #ff1744 !important"><i class="mdi-content-add activator"></i></a>

 

            <!--div id="flot-stacking-chart" class="section">
              <h4 class="header">IDEAL</h4>
              <div class="row">
                  ...
                  <div class="sample-chart-wrapper">
                    <div id="stacking" class="flotchart-placeholder"></div>
                            ...
                            <!--div class="col s12 m12 l6">
                                <div class="line-chart-wrapper" style="padding-top: 30px;">
                                    <span class="chart-title black-text"><strong>VENTAS MENSUALES</strong></span>
                                    <canvas id="line-chart" height="90"></canvas>
                                </div>
                            </div-->
                            <!--div class="col s12 m12 l12">
                                <div class="trending-bar-chart-wrapper">
                                    <span class="chart-title black-text"><strong>STOCK IDEAL</strong></span>
                                    <canvas id="trending-bar-chart" height="100"></canvas>                                                
                                </div>
                            </div-->
                        </div>
                        <div class="card-reveal">
                            <span class="card-title grey-text text-darken-4"><strong>INGRESOS DIARIOS DE LA SEMANA</strong><i class="mdi-navigation-close right"></i></span>
                            <table class="responsive-table">
                                <thead>
                                    <tr>
                                        <th data-field="month">FECHA</th>
                                        <th data-field="item-sold">CANTIDAD DE VENTAS</th>
                                        <th data-field="item-price">TOTAL VENDIDO</th>
                                    </tr>
                                </thead>
                                <tbody id="datos">
                                </tbody>
