          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Venta</h5>
                <ol class="breadcrumb">
...
<div class="row">
 <div class="col s12 m6 l2"> <p><a  class="btn" href="/listadeventa/"  >Volver</a></p></div>
    <div class="col s12 m6 l2" >

    <div id="generadordeventa" >
    <p><a  class="btn" href="#" id="generarventa" >Guardar</a></p>
    </div>
    </div>
    <div class="col s12 m6 l2"><p><a class="waves-effect waves-light btn modal-trigger" href="#modal1"   id="cobrarventas" >Aceptar y cobrar</a></p></div>
    <div class="col s12 m6 l2"><p><a class="btn" href="#" id="anularventa">Anular</a></p></div>
