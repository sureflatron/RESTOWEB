        ...
        <div id="chart-dashboard">
            ...
            <div class="row">
                ...
                <div class="col s12 m12 l12">  
                        <strong>EQQ CANTIDAD ECONOMICA :</strong>
                      <div class="row">
                      ...
                      <div class="col s4 m4 l4">
                       <strong>SELECCIONE PRODUCTO :</stron> 
                       <div class="col s12 m12 l12">
                            <select id="productoid">
                                <option>Cambiar producto a</option>
                            </select>
                        </div>                                    
                      </div>  
                          
                        </br>
                        <div class="col s4 m4 s4" style="padding: 15px; text-align: center;"> 
                    <a class="btn"  OnClick='ejecutareqq();'>Exec_EQQ</a>
                        </div>  
                    </div>
                    ...
                    <!--div class="card">
                        <!--div class="card-move-up waves-effect waves-block waves-light"-->
                            <!--div class="move-up cyan darken-1">
                                <!--div>
                                    <span class="chart-title white-text"><strong>EQQ-Cantidad Optima Inv.</strong></span>
                                </div>
                                <div class="trending-line-chart-wrapper">
                                    <canvas id="trending-line-chart" height="200"></canvas>                                    
                                </div>                                
                            </div-->
    ...
    <a class="btn-floating btn-move-up waves-effect waves-light darken-2 right" style="background-color: #ff1744 !important">
        <i class="mdi-content-add activator"></i></a>      
                        ...
                        <div class="card-reveal">
                            <span class="card-title grey-text text-darken-4"><strong>Control de Seguridad de Maximos y Minimos para Inventario</strong><i class="mdi-navigation-close right"></i></span>
                            <table class="responsive-table">
                                <thead>
                                    <tr>
                                        <th data-field="month">Nombre</th>
                                        <th data-field="item-sold">precioVenta</th>
                                        <th data-field="item-price">Stock</th>                                        
                                        <th data-field="item-price">StockMin</th>
                                        <th data-field="item-price">StockMax</th>
                                        <th data-field="item-price">PuntoPedido</th>
                                        <th data-field="item-price">consumoMedioDiario</th>
                                    </tr>
                                </thead>
                                <tbody id="datos">
                                </tbody>
            ...
            <div class="row"><!--style="color:#0000FF"-->
                 <div class="col s12 m12 l12">
                     <table class="egt" >
                         ...
                         <tr>
                           <th colspan="1" bgcolor="#BFF9FF">Co</th>
                          <td>costo de emisión de pedido = (D/Q) </td>
                         </tr>
                         <tr>
                             <td colspan="1" bgcolor="#BFF9FF">Ch</td>
                             <th>costo de almacenamiento = (Q/2) </th>                             
                         </tr>
                         <tr>
                             <td colspan="1" bgcolor="#BFF9FF">CT</td>
                             <th>costo total = (Co D / Q*) + Ch Q* / 2  </th>
                         </tr>
                         <tr>
                         <td colspan="1"bgcolor="#BFF9FF">Q*</td>
                         <th> tamaño óptimo del inventario =   √ 2 Co D / Ch </th>
                         </tr>
                     </table>
                </div>
...
<!--chart dashboard end-->
@section('scripts')
{!!Html::script('js/eqq.min.js')!!}
{!!Html::script('js/eqq.js')!!}
