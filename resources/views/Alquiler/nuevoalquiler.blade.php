        ...
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumbs">
                    ...
                    <li class="active">Nuevo Alquiler</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="row">
        ...
        @endif
        <div class="col s12 m4 l4 offset-s4">
            ...
            <div class=" col s12 grey lighten-5" style="border-radius: 5px;">
                <div class="row">
                    ...
                    <div class="input-field col col s12 m12 l6">
                        ...
                        <label for="barcode">Nombre de Producto:</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col s12">
    ...
    <div class="fixed-action-btn" style="bottom: 50px; right: 19px;">
        <a class="btn tooltipped waves-effect btn-floating btn-large  animated infinite bounce"
           href="#" data-position="left" data-delay="50" data-tooltip="COBRAR"
