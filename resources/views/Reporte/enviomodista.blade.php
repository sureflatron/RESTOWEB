...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>COMPRABANTE DE ENVIO MODISTA</title>
        <style>
            .empresa{
                text-align: center;
            }
    ...
    <body>
        <header>
            ...
            <div style="text-align: center;">
                <h2><strong>COMPROBANTE DE ENTREGA A MODISTA</strong></h2>
            </div>
        </header>
        ...
        <div style="border-bottom: 0px !important;">
            ...
            <table style="width: 100%;">
                <tr style="padding: 10px;font-size: 13px;">
                    <td colspan="4" style="text-align: center; border-bottom: 0px !important;  padding-top: 100px !important;"><strong style="border-top: 1px solid black;">FIRMA MODISTA:</strong></td>
                    <td style="text-align: center; border-bottom: 0px !important;  padding-top: 100px !important;"><strong style="border-top: 1px solid black;">FIRMA VENDEDOR</strong></td>
                </tr>
