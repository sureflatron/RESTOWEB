            ...
            <div class="row">
                <div class="empresa" style="position: relative;" >
                    <div style="width: 40%;">
                        ...
                        <h1 id="nombreempresa" style=" font-size: 18px;">{{ $empresa }} </h1>      
<!--                        <p style="padding-top: -15px; font-size: 14px;">De: {{ $propietario }}</p>-->
                    ...
                    <div style="position: absolute;">
                        <div style="text-align: left !important; padding-top: -150px; padding-left: 70%; font-size: 14px;">
                            ...
                            <div>
                                <strong>Registrado Por:</strong>&nbsp;&nbsp;&nbsp; {{ $vendedor }}
                            </div>
                        </div>    
                    </div>
                </div>
            ...
            <div style="text-align: center;">
                <h2><strong>RECIBO DE EGRESO</strong></h2>
            </div>
        </header>
        <div>
            <div>
                <input type="hidden" id='importe' value="{{ $importe }}">
                <div><strong>HEMOS CANCELADO A:</strong> &nbsp;&nbsp;&nbsp; {{ $recibidoDe }}</div>
                <div><strong>LA SUMA DE:</strong> &nbsp;&nbsp;&nbsp; {{ $importe }}</div>
                <div><strong style="color: white">LA SUMA DE:</strong> &nbsp;&nbsp;&nbsp; <span id="total"></span></div>
                <div><strong>POR CONCEPTO DE:</strong> &nbsp;&nbsp;&nbsp; {{ $glosa }}</div>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                var literal = $("#importe").val();
                var texto = LITERAL(literal);
                $("#total").text(texto);
            });
