          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"  style="text-align:center;">Reporte Raking por Importe de la fecha  {{ $Fechainicio  }} a  {{ $fechafin  }}</h5>
                <ol class="breadcrumb" >
                 
                     
                    <li><a onClick="imprimir()"  id="desaparece"  href="#" >Imprimir a PDF</a>
                  </li>     
                   <li><a href="/descargarRakingimporte/{{ $Fechainicio  }}/{{ $fechafin }}">Exportar a excel</a>
                  </li> 
...
@stop
  @section('scripts')
   ...
   {!!Html::script('js/extra/ReporteRakingimporte.js')!!}
@endsection
