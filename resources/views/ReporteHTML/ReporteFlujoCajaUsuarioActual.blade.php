          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"  style="text-align:center;">Flujo de caja  de Usuario de la fecha {{ $fechafin  }} a  {{ $Fechainicio }}</h5>
                <ol class="breadcrumb" >
                 
                     
                    <li><a onClick="imprimir()"  id="desaparece"  href="#" >Imprimir a PDF</a>
                  </li>     
                   <li><a         href="/descargarreporteflujocajausuario/{{$Fechainicio}}/{{$fechafin}}/{{$idEmpleado}}">Exportar a excel</a>
                  </li> 
...
<h4>Resumen</h4>
  ...
  <div class="row">
      ...
      <div class=" col s12 m6"><h4>TOTAL INGRESO :</h4></div>
            <div class=" col s12 m6"><h4 id="totalingresos">{{ $ingreso }}</h4></div>
     ...
     <div class="row">
      <div class=" col s12"> </div>
       <div class=" col s12 m6"><h4>(-)TOTAL EGRESO  :</h3> </div>
            <div class=" col s12 m6"><h4 id="totalegresos">{{ $egreso }}</h4></div>
          <li  ><div class="divider"></div></li>
    </div>
  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class=" col s12 m6"><h4>TOTAL Tarjeta  :</h4> </div>
            <div class=" col s12 m6"><h4  >{{ $contarjeta }}</h4>  </div>
    </div>
...
@stop
  @section('scripts')
    {!!Html::script('js/extra/FlujoCaja.js')!!}
@endsection
