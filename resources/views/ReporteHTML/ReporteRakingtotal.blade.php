          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"  style="text-align:center;">Reporte Raking por Cantidad de la fecha  {{ $Fechainicio  }} a  {{ $fechafin  }}</h5>
                <ol class="breadcrumb" >
...
@stop
  @section('scripts')
   ...
   {!!Html::script('js/extra/ReporteRakingtotal.js')!!}
@endsection
