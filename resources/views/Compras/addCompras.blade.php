    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Agregar Compra - Sucursal {!! Session::get('sucursal') !!}</h5>
...
<div class="row">
    <div class="col s12 grid-example">
        <h5><strong>Codigo Orden Compra:{!!$idventaultimo !!}</strong></h5>
    </div>
    <div class="col s12">
        <div class="row">
...
<div class="row">
    ...
    <div class="col s12">
        <table class="responsive-table dotted centered">
            <thead>
                <tr>
...
<div class="row">
    <div class="col s12 grid-example" id="det">
        <h5><strong>DETALLE DE ORDEN COMPRA</strong></h5>
    </div>
    <div class="col s12">
...
<form action="#">
    <p>
        ...
        <input name="group1" type="hidden" id="test3" onclick="ocultar();"  />
        <!--label for="test3">Tarjeta Debito</label-->
        <input name="group1" type="hidden" id="test4" onclick="ocultar();"  />
        <!--abel for="test4">Tarjeta Credito</label-->
        <input name="group1" type="hidden" id="test5" onclick="ocultar();"  />
        <!--label for="test5">Deposito a banco</label-->
        <input name="group1" type="hidden" id="test6" onclick="ocultar();"  />
...
<div class="row">
    <div class="col s12">
        <!--a href="#" id="guardaryimprimir" class="btn">GUARDAR E IMPRIMIR</a-->
         <a href="#" id="ordenaryimprimir" class="btn">ENVIAR ORDEN</a>
         <a href="#" id="volderyeliminar" class="btn">Volver Y Eliminar</a>
