        ...
        <div class="row">
            ...
            <div class="col s12 m6 l6">
                ...
                <div class="row">
                    <div class="col s12">
                        <h5><strong>TOTAL VENTA: </strong><i class="prefix">Bs.</i><span id="totalfijo">0</span></h5>
                          <h5><strong>DESCUENTO: </strong><i class="prefix">%.</i><span id="totalfijodescuento">0</span></h5>
                    </div>
                </div>
                <div class="divider"></div>
                <div class="row">
                ...
                <div>
                    ...
                    <label for="descuentoI" style="font-size: 15px;" visible="false" >Precio final de Venta(Bs)</label>
                </div>
                ...
                <div class="row" id="descuentoImpor" style="display: none;">
                    ...
                    <div class="col s12 m6 l6">
                        <input type='text' name='' value='0' id='totalcondescuento' min='0' onKeyUp="calcular_total_Modificado();" onkeypress="return NumCheck(event, this)">
                    </div>
                    <div class="col s12 m6 l6">
                    ...
                    <div class="row" id="pagoEfectivo" >
                        ...
                        <div class="col s12">
                            <div class="input-field col s12 m6 l6">
                                ...
                                <input type="text" class="importe_linea"  id="pago" onKeyUp="calcular_total();" onkeypress="return NumCheck(event, this)" placeholder=""/> 
                            </div>
                            <div class="input-field col s12 m6 l6">
                                <i class="prefix">Bs.</i>
                    ...
                    <div id="pagoCredito" class="row"  style="display: none;">
                        ...
                        <div class="col s12">
                            <div class="input-field col s12 m6 l6">
                                ...
                                <input type="text" value="0" id='aCuenta' onkeypress="return NumCheck(event, this)" onkeydown="calcular_totalCredito();" onKeyUp="calcularporcentaje();" placeholder=""/>
                            </div>
                            <div class="input-field col s12 m6 l6">
                                <i class="prefix">Bs.</i>
...
<div id="modal7" class="modal bottom-sheet modalF modal-fixed-footerF modal-fixed-footer">
    <div class="modal-content">
        <div class="row">
            <input type="hidden" name="_token" value="{{ csrf_token() }}" id="token">
            <input type="hidden" id="id">
            <input type="hidden" id="id">
            <input type="hidden" id="iddescuento2">
            <input type="hidden" id="totaldefacturas2">
            <input type="hidden" id="totaldefacturassindescuento2">
            <input type="hidden" id="descuentoasignado2" value="0">
            <h4 style="text-align: center;"><strong>Proceso Proforma</strong></h4>
            <div class="divider"></div>
            <div class="col s12 ">
                <div class="row">
                    ...
                    <div id="modalcobro" class="row" style="display: block;">
                        ...
                        <div class="input-field col s12">
                            <i class="mdi-action-account-circle prefix"></i>
                            @if( $idCliente == null)
                            <input type="text" list="clienteslist3" name="buscar_cliente" autocomplete="off" class="input-field" id="cliNombre3" required>
                            @else
                            <input type="text" list="clienteslist3" name="buscar_cliente" autocomplete="off" class="input-field" id="cliNombre3" value="{{$nombre}}" required>
                            @endif
                            <datalist id="clienteslist3">
                                @foreach($clientes as $datos)
                                <option data-id='{{ $datos->id }}' value="{{ $datos->nombre }}"> CODIGO: {{ $datos->id }}
                                    @endforeach
                            </datalist>
                    ...
                    <div class="input-field col s12 m6 l6">
                        ...
                        {!!Form::label('NIT','NIT: ')!!}
                        @if($nit == null)
                        <input type="text" value="0" id="nit3" onkeyup="buscarcliente();" placeholder="" onkeypress="return isNumberKey(this);"/> 
                        @else
                        <input type="text" value="{{ $nit }}" id="nit3" onkeyup="buscarcliente();" placeholder="" onkeypress="return isNumberKey(this);"/> 
                        @endif
                    </div>
                    <div class="input-field col s12 m6 l6">
                        <i class="mdi-action-perm-identity prefix"></i>
                        {!!Form::label('Nombre','Nombre: ')!!}
                        @if($nit == null)
                        <input type="text" value="SIN NOMBRE" id="razonsocial3" placeholder=""/>  
                        @else
                        <input type="text" value="{{ $razon }}" id="razonsocial3" placeholder=""/>  
                        @endif
                    </div>
                </div>
                
                <!--hasta aqui un div row primero-->
                
                <div class="row">
                    <div class="col s12">
                        <h5><strong>TOTAL VENTA: </strong><i class="prefix">Bs.</i><span id="totalfijo2">0</span></h5>
                          <h5><strong>DESCUENTO: </strong><i class="prefix">%.</i><span id="totalfijodescuento2">0</span></h5>
                    </div>
                </div>
                <div class="divider"></div>
                <div class="row">
                ...
                <div class="row" id="descuentoPor" style="display: block">
                    ...
                    <div class="col s12 m6 l6">
                        <select id="descuentosprof"></select>
                    </div>
                    <div class="col s12 m6 l6">
                        <h5>Importe es:  <i class="prefix">Bs.</i><span id="mostrardescuento2">0</span></h5>
                    </div>
                </div>
                <div class="row" id="descuentoImpor" style="display: none;">
                ...
                <div class="row">
                    <div class="col s12">
                        <h5><strong>TOTAL A COBRAR:</strong><i class="prefix">Bs.</i><span id='totalacobrarcondescuentoenlaventa2'></span></h5>
                    </div>
                </div>
                <div>
                    <table class="responsive-table striped">
    ...
    <div class="modal-footer">
        <a class="modal-action modal-close waves-effect waves-green btn-flat">Cerrar</a>
        {!!link_to('#', $title='Proforma', $attributes = ['id'=>'guardarproforma', 'class'=>'btn btn-primary' ], $secure = null)!!}
    </div>
</div>