        ...
        <div class="row">
            <div class="col s12 m12 l12">
                <ol class="breadcrumbs">
                    ...
                    <li class="active" style="color: black !important;"><strong>Editar Venta POS</strong> - &nbsp; &nbsp; 
                    ...
                    <div class="col s12 m6 l5">
                        <ul id="issues-collection" class="collection" style="margin: 0px !important; border: 0px !important;">
                            <li class="collection-item avatar">
                                ...
                                <h5><span class="collection-header" style="border-bottom: 0px !important;">TOTAL:</span>
...
@stop
@section('scripts')
{!! Html::script('js/addventaedit.js') !!} 
@endsection
