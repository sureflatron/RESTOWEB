        ...
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumbs">
                    ...
                    <li class="active" style="color: black !important;"><strong>Editar Venta RESTO</strong>&nbsp; &nbsp; || &nbsp; &nbsp; 
        ...
        <div class="col s12">
            <div class="row">
                <div class="col s12 m6 s3" style="padding: 10px; text-align: center;"> 
                    <a class="waves-effect waves-light btn center" href="#"  OnClick='cargarfactura();'>Cobrar</a>
                </div>  
                <div class="col s12 m6 s3" style="padding: 10px; text-align: center;">
                    <a class="btn" href="#" id="anularventa center ">Anular</a>
                </div>
                <div class="col s12 m6 s3" style="padding: 10px; text-align: center;">
                    <a class="waves-effect waves-light btn modal-trigger center" href="#modal3">Programar</a>
                </div>
                <div class="col s12 m6 s3" style="padding: 10px; text-align: center;">
                    <a  class="btn center" href="/listadeventares/" tooltips >volver</a>
                </div>
            </div>
        </div>
    </div>
