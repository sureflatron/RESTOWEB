        ...
        <div class="row">
            <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"> 
                    ...
                    <strong>Codigo Proforma:</strong> {!!$idventaultimo !!}  &nbsp; &nbsp; || &nbsp; &nbsp;  
...
<div class="row">
    ...
    <div class="col s12">
        <div class="row">
            <div id="detventa" class="grid-example col s12" style="text-align: center;">
                <span class="flow-text"><strong>DETALLE DE PROFORMA</strong></span>
            </div>
            <div class="row">
                <div class="col s12 m12 l12">
