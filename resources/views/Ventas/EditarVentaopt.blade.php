        ...
        <div class="row">
            <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">
                    <strong>Editar Venta OPTICA</strong>&nbsp; &nbsp; || &nbsp; &nbsp; 
                    <strong>Codigo Venta:</strong> {!!$id !!}  &nbsp; &nbsp; || &nbsp; &nbsp;
                ...
                <ol class="breadcrumbs">
                    ...
                    <li class="active">Editar Venta OPTICA</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="row" style="padding-top: 20px;">
    ...
    <div class="col s12 m6 l3">
        ...
        @else
        <input type="text" list="clienteslist" name="buscar_cliente" autocomplete="off" class="input-field" id="cliNombre" value="{{$nombre}}" required>
        @endif
...
<div class="row">
    <div class="grid-example col s12">
        <span class="flow-text"><strong>Editar Venta</strong></span>
    </div>
        ...
        <ul class="collapsible collapsible-accordion" data-collapsible="accordion">
            <li>
                ...
                <div class="collapsible-body" id="tipoproducto">
                    <div class="row" id="divrow2" style="text-align: center;">
                    </div>
                </div>
            </li>
            <li>
    ...
    <div class="col s12 m6 l6" id="nuevoventas">
        ...
        <h5>Fecha Entrega :</h5>
        <input id="fechaentregas" type="date" value="{!!$fecha !!}" placeholder="{!!$fecha !!}">
        <br>
        <div  class="col s6"  id="detalleoptica"> 
            <a class="waves-effect waves-light btn-large" id="ultimo"><i class="material-icons left">trending_flat</i>Agregar Detalle</a>
        </div>
        <div class="col s6"   id="editardetalleoptica" style="display:  none"> 
    ...
    <div class="col s12 m6 l6">
        <div class="row" id="datallleproducto">
            ...
            <div class="col s12 m6 l3">
                <input type="number" name="" value ="1" id="cantidadproducto"></div>
        ...
        <div class="col s12">
            <div class="row">
                ...
                <div class="col s12 m6 s3" style="padding: 10px; text-align: center;">
                    <a class="btn"  id="Imprimir"> Imprimir</a>
                </div>
                <div class="col s12 m6 s3" style="padding: 10px; text-align: center;">
