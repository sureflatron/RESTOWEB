    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Listado de Ventas RESTO</h5>
                <ol class="breadcrumbs">
                    <li><a href="/index">Dashboard</a></li>
                    <li class="active">Listado de Ventas RESTO</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="container">
    ...
    <div class="row" style="padding-bottom: 20px;">
        <div class="col s12">
            <a class="btn"  href="#" title="Nueva Venta" id="nuevaventasres">NUEVA VENTA</a>
        </div>
    </div>
...
@stop
@section('scripts')
{!! Html::script('js/addlistaventasres.js') !!}
@endsection